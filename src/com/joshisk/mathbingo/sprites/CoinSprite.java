...
public class CoinSprite extends Sprite {
	...
	public void setCoins(long coins) {
		...
		if(RM.activity.getApiClient().isConnected() 
				&& this.coins < 150) {

			int coinsEarned = (int)this.coins;

			switch (coinsEarned) {
			case 100:
				Games.Achievements.unlock(RM.activity.getApiClient(), RM.activity.getString(R.string.achievement_earn_100_coins));
			case 75:
				Games.Achievements.unlock(RM.activity.getApiClient(), RM.activity.getString(R.string.achievement_earn_75_coins));
			case 50:
				Games.Achievements.unlock(RM.activity.getApiClient(), RM.activity.getString(R.string.achievement_earn_50_coins));
			case 20:
				Games.Achievements.unlock(RM.activity.getApiClient(), RM.activity.getString(R.string.achievement_earn_20_coins));
			}
		}
